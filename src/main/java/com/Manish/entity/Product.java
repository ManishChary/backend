...
public class Product 
{
	...
	private ProductCategory category;//this is a property in productCategory class
	...
	public String toString() {
		return "product [id=" + id + ", category=" + category + ", sku=" + sku + 
				", name=" + name + ", description="
				+ description + ", unitPrice=" + unitPrice + 
				", imageUrl=" + imageUrl + ", active=" + active
				+ ", unitsInStock=" + unitsInStock + ", dateCreated=" + dateCreated + 
